...
void test_problem (double *xreal, double *xbin, int **gene, double *obj, double *constr)
{
	...
	obj[0] = (double) eva_objective1(xreal) ;
	obj[1] = (double) eva_objective2 ()   ;
    obj[2] = (double) (   -1  *  eva_objective3()  )      ;

    */

/*	obj[1] = (double) eva_objective2 ()  / numComparaciones ;
    obj[2] = (double) (   -1  *  eva_objective3()  )   /  firstAgrees   ;*/

    //Evalua restricciones
    int valConstr;
    constr[0] = eva_constr_violation_kendall( xreal );
    valConstr = constr[0];
